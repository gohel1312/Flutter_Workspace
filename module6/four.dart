        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10,),
              Text('Divya',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold)),
              Text('GohelDivya0167@gmail.com',style: Theme.of(context).textTheme.bodyText2,),
              SizedBox(height: 10,),
              SizedBox(
                width: 200,
